...
@media (max-width: 480px) {
    ...
    /* Additional New Code from Second Style */

    .charts-row {
    display: flex;
    flex-wrap: wrap;          /* allow wrapping on small screens */
    gap: 30px;                /* space between chart sections */
    justify-content: space-between;
    ...
    [data-theme-mode="dark"] .chart-section h3,
    .layout-dark .chart-section h3 {
        color: var(--dark-text, #f7fafc);
    }
    ...
    .dark-mode .pie-chart-wrapper,
    [data-theme-mode="dark"] .pie-chart-wrapper,
    .layout-dark .pie-chart-wrapper {
        background: var(--dark-chart-bg, #2d3748);
        border: 1px solid var(--dark-chart-border, rgba(255, 255, 255, 0.08));
        box-shadow: 0 2px 12px rgba(0, 0, 0, 0.2);
    }
    ...
    .dark-mode .pie-legend-item,
    [data-theme-mode="dark"] .pie-legend-item,
    .layout-dark .pie-legend-item {
        color: var(--dark-text-muted, #a0aec0);
    }
